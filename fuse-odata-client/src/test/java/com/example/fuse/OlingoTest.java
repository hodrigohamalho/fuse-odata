 ...
 * </p>
 */
public class OlingoTest extends AbstractOlingo4TestSupport {

    private static final Logger LOG = LoggerFactory.getLogger(OlingoTest.class);
    ...
    public void testCreateUpdateDelete() throws Exception {
        ...
        System.out.println(TEST_SERVICE_BASE_URL);
        ...
        // update
        clientEntity.getProperties().add(objFactory.newPrimitiveProperty("MiddleName", objFactory.newPrimitiveValueBuilder().buildString("Silva")));
